...
(define (heap-merge h1 h2)
  (cond
   ...
   [(leaf? h2) h1]
   [else
    (if (< (elem-val (heap-min h1)) (elem-val (heap-min h2)))
        (make-node (node-elem h1) (heap-merge (node-right h1) h2) (node-left h1))
        (make-node (node-elem h2) (heap-merge (node-right h2) h1) (node-left h2)))]))
...
(sorted? (heapsort (randlist 200 100)))
(sorted? (heapsort (randlist 500 1000)))
(sorted? (heapsort (randlist 10000 10000)))
